...
"""base_varupdate_run
function! base#varupdate#run (ref)
 ...
 elseif type(a:ref) == type([])
   let vars=a:ref
   for varname in vars
     call base#varupdate#run(varname)
   endfor
...
"""F_Bushes
  ...
  elseif varname == 'LASU_ShowallLines'
    ...
    call base#varupdate#run([ 'PAP_psec' ])
...
"""comment_char
     elseif varname == 'comment_char'
             call base#varupdate#run('comment_chars')
...
"""DC_Proj_SecNames
     ...
     elseif varname == 'OMNI_CompOptions_List'
        call base#varupdate#run('OMNI_COMP_ARRAYS')
...
"""perl_installed_modules
     ...
     elseif varname == 'APACHE_Files'
        ...
        call base#varupdate#run('APACHE_FilesList')
...
"""varupdate_pluginfiles
     ...
     elseif varname == 'allplugins'
        ...
        call base#varupdate#run('pluginroot')
...
"""varupdate_rtp
     elseif varname == 'rtp'
        ...
        call base#varupdate#run('plugins')
        call base#varupdate#run('pluginroot')
